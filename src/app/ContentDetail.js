...
function ContentDetail({ title, startYear, cover_pic,endYear,list_type, contentDetClass,proj_title, description, bodyClass,list_title }) {
    return (
        <section className={contentDetClass ? 'content_detail_proj' : 'content_detail'}>
            {startYear &&<div className="content_detail_tenure">
