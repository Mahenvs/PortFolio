...
export default function Resume() {
    ...
    const education_details = [
        {
            role_title: "Bachelor of Technology (BTech) in Computer Science Engineering(CSE)",
            startYear: "08/2015",
            endYear: "06/2019",
    ...
    const skills = ['Proficient in Angular & React Framework', 
        `Experience in Creating and Consuming API’s through REST`, 'Have Experience in Data Structures & Algorithms', 
        ...
        'Have Experience in SCSS', 'Software Development Life Cycle (SDLC)',
    ]
